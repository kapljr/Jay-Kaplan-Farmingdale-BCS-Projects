<h2>{msgNewContentHeader}</h2>
            ...
            <form id="formValues" action="#" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label" for="rubrik">{msgNewContentCategory}</label>
                    <div class="col-lg-9">
                        <select class="form-control" name="rubrik[]" id="rubrik" multiple="multiple" size="5" required>
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label" for="question">{msgNewContentTheme}</label>
                    <div class="col-lg-9">
                        <textarea class="form-control" cols="37" rows="3" name="question" id="question" required="required" {readonly}>{printQuestion}</textarea>
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-lg-3 control-label" for="answer">{msgNewContentArticle}</label>
                    <div class="col-lg-9">
                        <textarea class="form-control" cols="37" rows="10" name="answer" id="answer" required="required"></textarea>
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-lg-3 control-label" for="keywords">{msgNewContentKeywords}</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label" for="contentlink">{msgNewContentLink}</label>
                    <div class="col-lg-9">
                        <input type="url" class="form-control" name="contentlink" id="contentlink" size="37" value="http://" />
                    </div>
                </div>
