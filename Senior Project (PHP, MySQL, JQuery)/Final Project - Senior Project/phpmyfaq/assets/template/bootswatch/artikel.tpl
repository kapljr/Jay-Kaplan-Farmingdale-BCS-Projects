            ...
            <div class="tab-content faq-information">
                <div class="tab-pane fade active in" id="authorInfo">
                ...
                <div class="tab-pane fade hidden-print" id="votingForm">
                ...
                <div class="tab-pane fade hidden-print" id="switchAvailableLanguage">
                    {switchLanguage}
                </div>
                <div class="tab-pane fade hidden-print" id="addTranslation">
