...
.btn-primary {
  ...
  background-image: linear-gradient(to bottom, #f89406, #f8e506);
  background-repeat: repeat-x;
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#fff89406', endColorstr='#fff8e506', GradientType=0);
...
.Xnavbar-inner {
  ...
  background-image: -moz-linear-gradient(top, #686f7a, #686f7a);
  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#686f7a), to(#686f7a));
  background-image: -webkit-linear-gradient(top, #686f7a, #686f7a);
  background-image: -o-linear-gradient(top, #686f7a, #686f7a);
  background-image: linear-gradient(to bottom, #686f7a, #686f7a);
  background-repeat: repeat-x;
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ff686f7a', endColorstr='#ff686f7a', GradientType=0);
...
.navbar .btn-navbar {
  ...
  text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);
  background-color: #5c626c;
  background-image: -moz-linear-gradient(top, #5c626c, #5c626c);
  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#5c626c), to(#5c626c));
  background-image: -webkit-linear-gradient(top, #5c626c, #5c626c);
  background-image: -o-linear-gradient(top, #5c626c, #5c626c);
  background-image: linear-gradient(to bottom, #5c626c, #5c626c);
  background-repeat: repeat-x;
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ff5c626c', endColorstr='#ff5c626c', GradientType=0);
  border-color: #5c626c #5c626c #393d43;
  border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25);
  *background-color: #5c626c;
  /* Darken IE7 buttons by default so they stand out more given they won't have borders */
